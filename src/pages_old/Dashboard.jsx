...
export default function Dashboard({ session }) {
  ...
  const s = {
    ...
    navLogo: { fontFamily: "'Playfair Display',Georgia,serif", color: '#c8a97e', fontSize: '1.2rem', display: 'flex', alignItems: 'center', gap: '0.5rem' },
    ...
    body: { maxWidth: '820px', margin: '0 auto', padding: '3rem 1.5rem' },
    greeting: { fontFamily: "'Playfair Display',Georgia,serif", fontSize: 'clamp(1.6rem,4vw,2.4rem)', color: '#e8d5b0', marginBottom: '0.4rem' },
    sub: { color: '#5a5248', fontSize: '0.88rem', marginBottom: '2.5rem' },
    banner: { background: 'rgba(200,169,126,0.06)', border: '1px solid rgba(200,169,126,0.15)', borderRadius: '12px', padding: '1.2rem 1.5rem', marginBottom: '2rem', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '1rem' },
    bannerText: { fontSize: '0.87rem', color: '#a09070' },
    bannerBtn: { padding: '0.5rem 1.2rem', background: 'linear-gradient(135deg,#c8a97e,#a0845e)', border: 'none', borderRadius: '999px', color: '#0d0f0a', fontSize: '0.82rem', fontFamily: "'Playfair Display',Georgia,serif", fontWeight: 700, cursor: 'pointer' },
    grid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(220px,1fr))', gap: '1rem', marginBottom: '2.5rem' },
    card: { background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.06)', borderRadius: '12px', padding: '1.5rem', cursor: 'pointer', transition: 'all 0.2s' },
    cardIcon: { fontSize: '1.4rem', marginBottom: '0.6rem' },
    cardTitle: { fontFamily: "'Playfair Display',Georgia,serif", color: '#e8d5b0', fontSize: '0.95rem', marginBottom: '0.3rem' },
    ...
    sessionCard: { background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.06)', borderRadius: '10px', padding: '1rem 1.3rem', marginBottom: '0.6rem', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'space-between', transition: 'all 0.2s' },
  ...
  return (
    <div style={s.page}>
      <nav style={s.nav}>
        <div style={s.navLogo}>⟡ Sage</div>
        <div style={s.navRight}>
          <button style={s.navBtn} onClick={() => navigate('/readings')}>Past Readings</button>
          <button style={s.navBtn} onClick={() => navigate('/profile')}>Profile</button>
          <button style={s.navBtn} onClick={() => supabase.auth.signOut()}>Sign Out</button>
        </div>
      </nav>
